...
public class PlayerProfileManager implements Listener {
    ...
    public Inventory getProfileGUI(Player player) {
        ...
        friendAddMeta.setDisplayName(ChatColor.AQUA + "Add Friend");
        friendAddMeta.setLore(Arrays.asList("", ChatColor.YELLOW + "Click to add!"));
        ...
        friendListMeta.setDisplayName(ChatColor.AQUA + "Friends List");
        friendListMeta.setLore(Arrays.asList("", ChatColor.YELLOW + "Click to view!"));
        ...
        ignoreAddMeta.setDisplayName(ChatColor.RED + "Ignore Player");
        ignoreAddMeta.setLore(Arrays.asList("", ChatColor.YELLOW + "Click to add!"));
        ...
        ignoreListMeta.setDisplayName(ChatColor.RED + "Ignored List");
        ignoreListMeta.setLore(Arrays.asList("", ChatColor.YELLOW + "Click to view!"));
        ...
        partyCreateMeta.setDisplayName(ChatColor.BLUE + "Create Party");
        partyCreateMeta.setLore(Arrays.asList("", ChatColor.YELLOW + "Click to create!"));
        ...
        guildCreateMeta.setDisplayName(ChatColor.DARK_GREEN + "Create Guild");
        guildCreateMeta.setLore(Arrays.asList("", ChatColor.YELLOW + "Click to create!"));
        ...
        privacySettingsMeta.setDisplayName(ChatColor.GREEN + "Privacy Settings");
        privacySettingsMeta.setLore(Arrays.asList("", ChatColor.YELLOW + "Click to view!"));
        ...
        if (slots.isEmpty()) {
            ...
            for (int i = 20; i <= 25; i++) {
                ...
                paperMeta.setDisplayName(ChatColor.GRAY + "COMING SOON");
    ...
    public Inventory getPrivacySettingsGUI(Player player) {
        ...
        guildInvitesMeta.setDisplayName(ChatColor.DARK_GREEN + "Guild Invites");
        guildInvitesMeta.setLore(Arrays.asList("", ChatColor.YELLOW + "Click to enable/disable!"));
        ...
        friendInvitesMeta.setDisplayName(ChatColor.AQUA + "Friend Invites");
        friendInvitesMeta.setLore(Arrays.asList("", ChatColor.YELLOW + "Click to enable/disable!"));
        ...
        partyInvitesMeta.setDisplayName(ChatColor.BLUE + "Party Invites");
        partyInvitesMeta.setLore(Arrays.asList("", ChatColor.YELLOW + "Click to enable/disable!"));
        ...
        profileViewingMeta.setDisplayName(ChatColor.LIGHT_PURPLE + "Profile Viewing");
        profileViewingMeta.setLore(Arrays.asList("", ChatColor.YELLOW + "Click to enable/disable!"));
